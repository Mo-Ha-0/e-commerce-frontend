        ...
        <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {stats.map((s) => (
                    ...
                    >
                        <div
                            className={`w-10 h-10 ${s.color} rounded-lg flex items-center justify-center mb-4`}
                        >
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    {!orders ? (
                        ...
                        <div className="space-y-3">
                            ...
                            <Link
                                to="/admin/orders"
                                className="block text-center text-sm text-indigo-600 hover:text-indigo-800 mt-3 font-medium"
                            >
                                View All Orders
                            </Link>
                        </div>
